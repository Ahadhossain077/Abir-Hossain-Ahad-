...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕ AHAD ▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
...
\033[1;91m☞ Auther     : ABIR HOSSAIN AHAD OLD CRUW SYLHET GANG 
\033[1;92m☞ WhatsApp   : 01764407193
\033[1;95m☞ From    : MANIKGANJ.DHAKA.BANGLADESH 
\033[;97m👉 Leve  : POULY GRAM
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num 01764407193✓')
	    psb('WellCome To ABIR HOSSAIN AHAD STRICT')
	    psb('Congratulations AHAD HOSSAIN Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ AHAD✓')
	    psb('🔓Password ☆ AHAD✓')
	    psb('FOLLOW ME ON FACEBOOK ABIR HOSSAIN AHAD✓')
